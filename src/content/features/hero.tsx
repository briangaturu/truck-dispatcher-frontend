  ...
  <>
    <style>{`
      ...
      .fh-ring-1 {
        ...
        animation: fh-spin 60s linear infinite;
      }
      .fh-ring-2 {
        ...
        animation: fh-spin 45s linear infinite reverse;
      }
      .fh-dots-1 {
    ...
    <section className="fh-section">
      <div className="fh-shape fh-ring-1" />
      <div className="fh-shape fh-ring-2" />
      <div className="fh-shape fh-dots-1" />
      <div className="fh-shape fh-dots-2" />

      <div className="fh-inner">
        <div className="fh-eyebrow"><span className="fh-eyebrow-dot" />Our Capabilities</div>
        <h1 className="fh-title">
          Powerful <span className="fh-title-accent">Features</span> Built for You
        </h1>
        <p className="fh-desc">
          Discover the comprehensive toolkit designed to streamline your dispatch operations and maximize efficiency.
        </p>
      </div>
    </section>
  </>
